...
public protocol ImpactFeedbackGenerator {
    ...
    func create(id: AnyHashable, style: UIImpactFeedbackGenerator.FeedbackStyle) -> Effect<Never>
    ...
    func impactOccurred(id: AnyHashable) -> Effect<Never>

    /// Triggers impact event with the given intensity value
    func impactOccurred(id: AnyHashable, withIntensity intensity: CGFloat) -> Effect<Never>
